...
@section('title', 'Oportunidades de Craft — AlbionMillionaire')
    ...
    <form method="GET" action="{{ route('crafting.index') }}" id="filterForm">
      ...
      <div class="filters-body" id="filtersBody">
        <div class="filters-grid" style="padding-top:16px">
          ...
          {{-- % mínimo Ordem --}}
          <div class="filter-group">
            <label data-i18n="crafting.filter.pct_min_ordem">% Mínimo Lucro (Ordem)</label>
          ...
          {{-- % mínimo Direto --}}
          <div class="filter-group">
            <label data-i18n="crafting.filter.pct_min_direto">% Mínimo Lucro (Direto)</label>
